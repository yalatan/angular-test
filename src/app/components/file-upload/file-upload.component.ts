...
// import { ProfileCleanerService } from 'app/main/profile-cleaner/profile-cleaner.service';
...
export class FileUploadComponent implements OnInit {
  ...
  constructor(private _http: HttpClient,
            //   public profileCleanerService: ProfileCleanerService
              ) { }
  ...
  onClick(): void  {
    ...
    fileUpload.onchange = () => {
          ...
          for (let index = 0; index < fileUpload.files.length; index++) {
            ...
            //     this.profileCleanerService._profileFile.next(file.name);
...
private uploadFile(file: FileUploadModel): void  {
    ...
    file.sub = this._http.request(req).pipe(
          ...
          (event: any) => {
            ...
            //     this.profileCleanerService._profileFile.next(file.data.name);
          }
    );
}
